...
public class UserController2 {
    ...
    public SingleResult<User2> findUserById(@ApiParam(value = "회원ID", required = true) @PathVariable int userId,
    ...
    public SingleResult<User2> save(@ApiParam(value = "회원아이디", required = true) @RequestParam String uid,
